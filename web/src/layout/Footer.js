...
export const Footer = () => {
  ...
  return (
    <footer className={classes.footer}>
      ...
      >
        <span>
          Anyway, if you would like to ask a question or suggest an improvement
      ...
      <Typography
        ...
        component='p'
      >
        Moreover - you can make your own{' '}
        <Link href='https://github.com/kos33rd/ac-friends'>
          New Friends app
        </Link>{' '}
        - it's totally opensource 🎉
      </Typography>
      <Copyright />
    </footer>
  )
